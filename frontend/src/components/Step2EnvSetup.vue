    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          <p class="description">
            Creates a new simulation instance and pulls the simulated world parameter template.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          <p class="description">
            Using the context, tools are automatically called to extract entities and relationships from the knowledge graph, initialize simulated individuals, and give them unique behaviors and memories based on real-world seeds.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="description">
            Based on simulation requirements and real-world seeds, the LLM intelligently sets the world's time flow rate, recommendation algorithm, each individual's active hours, posting frequency, event triggers, and other parameters.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <!-- Round count config - only shown once config generation completes and rounds are calculated -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">Simulation Round Settings</span>
                <span class="section-desc">AI Swarm automatically plans a prediction of <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> real-world hours, where each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of elapsed time</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>At 100 agents: estimated time ~{{ Math.round(customMaxRounds * 0.6) }} min</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        At 100 agents: estimated time {{ Math.round(autoGeneratedRounds * 0.6) }} min
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">If this is your first run, we strongly recommend switching to "Custom mode" to reduce the number of rounds, allowing for a faster preview and lower risk of errors ➝</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                ...
                <span class="dim-desc">Complete behavioral trace during this event</span>
              </div>
              <div class="dimension-card">
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Existing prepared data detected, using it directly')
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        // 配置尚未生成，开始轮询
        addLog('Config generating, polling for updates...')
        startConfigPolling()
      }
    }
  } catch (err) {
...
.badge.pending { background: var(--surface-alt); color: var(--muted); }
